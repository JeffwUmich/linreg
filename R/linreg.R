...
#' estimating the corresponding beta coefficients and their standard errors,
#' as well as conducting pairwise inference via a two-sided t-test.
#'
#' @param formula An object of class \code{\link{formula}}, specifying the model to be fitted.
#' @param data A data frame containing the variables referenced in the formula. This should include the response and explanatory variables.
#' @return A matrix containing the estimated beta coefficients and standard errors as well as the t-values, and p-values for each predictor in the model.
#' @examples
#' # Example of using linear_regression with the mtcars dataset
